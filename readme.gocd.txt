...
Click + on top right, 
repository name: gocd_template

click "Create repository" button.

2. Open Terminal.
3. Change the current working directory to your local project.
   cd /home/sliu/internet_code/internet_code1/gocd_template
...
7. At the top of your GitHub repository's Quick Setup page, click copy icon to copy the remote repository URL. 
   Right click "sliu99/gocd_template" and copy the link (https://github.com/sliu99/gocd_template)
...
Pipeline Name: gocd_template
Pipeline Group Name: dev            

Step2 Materials:
Material Type: Git
URL: https://github.com/sliu99/gocd_template.git
...
Then add a new stage RunDockerContainer in the same pipeline.
Command: /bin/sh
Arguments: run_docker_container_only.sh

target (with jar files) is created at /var/lib/go-agent/pipelines/gocd_template
